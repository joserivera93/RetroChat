...
import com.example.retrochat.adapters.MessagesAdapter;
import com.example.retrochat.models.Chat;
import com.example.retrochat.models.FCMBody;
import com.example.retrochat.models.FCMResponse;
import com.example.retrochat.models.Message;
import com.example.retrochat.providers.AuthProvider;
import com.example.retrochat.providers.ChatsProvider;
import com.example.retrochat.providers.MessagesProvider;
        ...
        mMessagesProvider.getLastMessageSender(mExtraIdChat, idSender).get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                ...
                if (queryDocumentSnapshots != null) {
                    ...
                    Toast.makeText(ChatActivity.this, "No hay documentos", Toast.LENGTH_SHORT).show();
                }
