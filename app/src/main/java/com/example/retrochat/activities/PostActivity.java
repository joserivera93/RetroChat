...
import com.example.retrochat.providers.ImageProvider;
import com.example.retrochat.providers.PostProvider;
import com.example.retrochat.utils.FileUtil;
...
public class PostActivity extends AppCompatActivity {
    ...
    private void takePhoto(int requestCode) {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri photoUri = FileProvider.getUriForFile(PostActivity.this, "com.example.retrochat", photoFile);
